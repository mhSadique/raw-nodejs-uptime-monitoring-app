...
// The below api has not been tested
// test it later
                                ...
                                data.read('users', parseJSON(checkData).userPhone, (err3, userData) => {
                                    ...
                                    if (!err3 && userData) {
                                        ...
                                        if (checkPosition > -1) {
                                            ...
                                            // resave/update the user data
                                            userObject.checks = userChecks;
                                            data.update('users', userObject.phone, userObject, (err2) => {
                                                if (!err4) {
                                                    callback(200);
                                                } else {
                                                    callback(500, {
                                            ...
                                            callback(500, {
                                                error: 'The check id you are trying to remove in not found!'
                                            })
                                        }
                                    } else {
                                        callback(500, {
